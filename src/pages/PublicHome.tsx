...
export const PublicHome: FC = () => {
  ...
  return (
    <main 
      className={`min-h-dvh text-white selection:bg-accent-violet/30 cursor-none [&_a]:cursor-none [&_button]:cursor-none ${lang === 'ar' ? 'rtl font-arabic' : 'ltr uppercase-none'}`}
    >
      <motion.div 
      ...
      {sections
        ...
        return (
          <div 
            ...
            className={
              section.id === 'hero' 
                ? 'sticky top-0 h-dvh z-0 overflow-hidden' 

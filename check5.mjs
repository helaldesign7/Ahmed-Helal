...
async function run() {
  ...
  const leadsInfo = data.definitions ? data.definitions.leads : data.components.schemas.leads;
  console.log(leadsInfo ? Object.keys(leadsInfo.properties) : 'Leads schema not found!');
}
run();
